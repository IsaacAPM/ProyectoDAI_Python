...
#%%
#En esta celda se lee el archivo de crímenes y se gurada en max_crime los datos de los 
#tres países con más crimen
...
#%%
<<<<<<< HEAD
#En esta celda se grafican los datos obtenidos en la anterior (max)
=======
#En esta celda se grafica los datos optenidos 
>>>>>>> 80f1ef84cf635a532c5e21d0eed54724a4aede0f
...
#%%
<<<<<<< HEAD
#En esta celda se extraen los datos de los países obtenidos en la primera celda de la tabla GNI per capita 
=======
...
#%%
<<<<<<< HEAD
#En esta celda se extraen los datos de los países obtenidos en la primera celda de la tabla Gross enrolment ratio secondary education
=======
...
#%%
#En esta celda se grafica la variación del GNI per capita de los tres países con mayor y menor índice de criminalidad 
...
axes.set_xlabel("Año")
axes.set_ylabel("Inscripciones a educación secundaria")
axes.legend(loc="upper left")
